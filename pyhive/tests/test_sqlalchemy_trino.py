...
class TestSqlAlchemyPresto(unittest.TestCase, SqlAlchemyTestCase):
    def create_engine(self):
        return create_engine('trino://localhost:8080/hive/default?source={}'.format(self.id()))

    def test_bad_format(self):
        self.assertRaises(
            ValueError,
            lambda: create_engine('trino://localhost:8080/hive/default/what'),
        )
    ...
    def test_url_default(self):
        engine = create_engine('trino://localhost:8080/hive')
        try:
