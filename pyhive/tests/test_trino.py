...
class TestTrino(unittest.TestCase, DBAPITestCase):
    __test__ = True
    ...
    def test_poll(self, cursor):
        self.assertRaises(trino.ProgrammingError, cursor.poll)
    ...
    def test_invalid_protocol_config(self):
        ...
        self.assertRaisesRegexp(
            ValueError, 'Protocol.*https.*password', lambda: trino.connect(
    ...
    def test_invalid_password_and_kwargs(self):
        ...
        self.assertRaisesRegexp(
            ValueError, 'Cannot use both', lambda: trino.connect(
    ...
    def test_invalid_kwargs(self):
        ...
        self.assertRaisesRegexp(
            ValueError, 'Cannot override', lambda: trino.connect(
